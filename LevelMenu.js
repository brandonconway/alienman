...
BasicGame.LevelMenu.prototype = {
	...
	this.level1 = this.add.button(400, 100, 'playButton', function(){this.startGame({'level': 1});}, this, 'buttonOver', 'buttonOver');
	this.level1Text = this.add.text(this.level1.x + this.level1.width+10, this.level1.y, "Level 1", this.style);
	this.level2 = this.add.button(400, 50+this.level1.y, 'playButton', function(){this.startGame({'level': 2});}, this, 'buttonOver', 'buttonOver');
	this.level2Text = this.add.text(this.level2.x + this.level2.width+10, this.level2.y, "Level 2", this.style);
	this.level3 = this.add.button(400, 50+this.level2.y, 'playButton', function(){this.startGame({'level': 3});}, this, 'buttonOver', 'buttonOver');
